...
type AllocationFactor struct {
	...
	AllocationType AllocationType `protobuf:"varint,2,opt,name=allocation_type,json=allocationType,proto3,enum=protolca.AllocationType" json:"allocation_type,omitempty"`
	...
	// in this process.
	Product *Ref `protobuf:"bytes,3,opt,name=product,proto3" json:"product,omitempty"`
	...
	Exchange *ExchangeRef `protobuf:"bytes,6,opt,name=exchange,proto3" json:"exchange,omitempty"`
}
...
type CalculationSetup struct {
	...
	WithRegionalization bool `protobuf:"varint,6,opt,name=with_regionalization,json=withRegionalization,proto3" json:"with_regionalization,omitempty"`
	// The normalisation and weighting set for the calculation (optional).
	NwSet *Ref `protobuf:"bytes,7,opt,name=nw_set,json=nwSet,proto3" json:"nw_set,omitempty"`
	// The calculation type to be used in the calculation (optional).
	AllocationMethod AllocationType `protobuf:"varint,8,opt,name=allocation_method,json=allocationMethod,proto3,enum=protolca.AllocationType" json:"allocation_method,omitempty"`
	// A list of parameter redefinitions to be used in the calculation
	// (optional).
	ParameterRedefs []*ParameterRedef `protobuf:"bytes,9,rep,name=parameter_redefs,json=parameterRedefs,proto3" json:"parameter_redefs,omitempty"`
	// (optional)
	Amount float64 `protobuf:"fixed64,10,opt,name=amount,proto3" json:"amount,omitempty"`
	// (optional)
	Unit *Ref `protobuf:"bytes,11,opt,name=unit,proto3" json:"unit,omitempty"`
	// (optional)
...
type Exchange struct {
	...
	AvoidedProduct bool `protobuf:"varint,2,opt,name=avoided_product,json=avoidedProduct,proto3" json:"avoided_product,omitempty"`
	// A formula for calculating the costs of this exchange.
	CostFormula string `protobuf:"bytes,3,opt,name=cost_formula,json=costFormula,proto3" json:"cost_formula,omitempty"`
	// The costs of this exchange.
	CostValue float64 `protobuf:"fixed64,4,opt,name=cost_value,json=costValue,proto3" json:"cost_value,omitempty"`
	// The currency in which the costs of this exchange are given.
	Currency *Ref `protobuf:"bytes,5,opt,name=currency,proto3" json:"currency,omitempty"`
	...
	InternalId int32 `protobuf:"varint,6,opt,name=internal_id,json=internalId,proto3" json:"internal_id,omitempty"`
	// The reference to the flow of the exchange.
	Flow *Ref `protobuf:"bytes,7,opt,name=flow,proto3" json:"flow,omitempty"`
	// The quantity in which the amount is given.
	FlowProperty *Ref `protobuf:"bytes,8,opt,name=flow_property,json=flowProperty,proto3" json:"flow_property,omitempty"`
	Input        bool `protobuf:"varint,9,opt,name=input,proto3" json:"input,omitempty"`
	// Indicates whether the exchange is the quantitative reference of the
	// process.
	QuantitativeReference bool    `protobuf:"varint,10,opt,name=quantitative_reference,json=quantitativeReference,proto3" json:"quantitative_reference,omitempty"`
	BaseUncertainty       float64 `protobuf:"fixed64,11,opt,name=base_uncertainty,json=baseUncertainty,proto3" json:"base_uncertainty,omitempty"`
	...
	DefaultProvider *Ref    `protobuf:"bytes,12,opt,name=default_provider,json=defaultProvider,proto3" json:"default_provider,omitempty"`
	Amount          float64 `protobuf:"fixed64,13,opt,name=amount,proto3" json:"amount,omitempty"`
	AmountFormula   string  `protobuf:"bytes,14,opt,name=amount_formula,json=amountFormula,proto3" json:"amount_formula,omitempty"`
	Unit            *Ref    `protobuf:"bytes,15,opt,name=unit,proto3" json:"unit,omitempty"`
	...
	DqEntry     string       `protobuf:"bytes,16,opt,name=dq_entry,json=dqEntry,proto3" json:"dq_entry,omitempty"`
	Uncertainty *Uncertainty `protobuf:"bytes,17,opt,name=uncertainty,proto3" json:"uncertainty,omitempty"`
...
func (x *ExchangeRef) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
type FlowMapRef struct {
	...
	Provider *Ref `protobuf:"bytes,5,opt,name=provider,proto3" json:"provider,omitempty"`
}
...
type FlowResult struct {
	...
	// regionalized result.
	Location *Ref `protobuf:"bytes,5,opt,name=location,proto3" json:"location,omitempty"`
}
...
type ImpactFactor struct {
	...
	Location *Ref `protobuf:"bytes,3,opt,name=location,proto3" json:"location,omitempty"`
	// The quantity of the flow to which the LCIA factor is related (e.g. Mass).
	FlowProperty *Ref `protobuf:"bytes,4,opt,name=flow_property,json=flowProperty,proto3" json:"flow_property,omitempty"`
	// The flow unit to which the LCIA factor is related (e.g. kg).
	Unit *Ref `protobuf:"bytes,5,opt,name=unit,proto3" json:"unit,omitempty"`
	...
	Uncertainty *Uncertainty `protobuf:"bytes,8,opt,name=uncertainty,proto3" json:"uncertainty,omitempty"`
}
...
type ImpactResult struct {
	...
	ImpactCategory *Ref `protobuf:"bytes,2,opt,name=impact_category,json=impactCategory,proto3" json:"impact_category,omitempty"`
	// The value of the flow amount.
...
type NwFactor struct {
	...
	Type                string  `protobuf:"bytes,1,opt,name=type,json=@type,proto3" json:"type,omitempty"`
	ImpactCategory      *Ref    `protobuf:"bytes,2,opt,name=impact_category,json=impactCategory,proto3" json:"impact_category,omitempty"`
	NormalisationFactor float64 `protobuf:"fixed64,3,opt,name=normalisation_factor,json=normalisationFactor,proto3" json:"normalisation_factor,omitempty"`
	WeightingFactor     float64 `protobuf:"fixed64,4,opt,name=weighting_factor,json=weightingFactor,proto3" json:"weighting_factor,omitempty"`
}
...
func (x *NwFactor) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
type NwSet struct {
	...
	WeightedScoreUnit string `protobuf:"bytes,7,opt,name=weighted_score_unit,json=weightedScoreUnit,proto3" json:"weighted_score_unit,omitempty"`
	// The list of normalization and weighting factors of this set.
	Factors []*NwFactor `protobuf:"bytes,8,rep,name=factors,proto3" json:"factors,omitempty"`
}
...
type ParameterRedef struct {
	...
	Context *Ref `protobuf:"bytes,2,opt,name=context,proto3" json:"context,omitempty"`
	...
	Uncertainty *Uncertainty `protobuf:"bytes,5,opt,name=uncertainty,proto3" json:"uncertainty,omitempty"`
...
type ParameterRedefSet struct {
	...
	// product system.
	IsBaseline bool `protobuf:"varint,4,opt,name=is_baseline,json=isBaseline,proto3" json:"is_baseline,omitempty"`
	// The parameter redefinitions of this redefinition set.
	Parameters []*ParameterRedef `protobuf:"bytes,5,rep,name=parameters,proto3" json:"parameters,omitempty"`
}
...
func (x *ParameterRedefSet) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
type SocialAspect struct {
	...
	ActivityValue float64 `protobuf:"fixed64,2,opt,name=activity_value,json=activityValue,proto3" json:"activity_value,omitempty"`
	...
	// numeric currently)
	RawAmount       string    `protobuf:"bytes,5,opt,name=raw_amount,json=rawAmount,proto3" json:"raw_amount,omitempty"`
	RiskLevel       RiskLevel `protobuf:"varint,6,opt,name=risk_level,json=riskLevel,proto3,enum=protolca.RiskLevel" json:"risk_level,omitempty"`
	SocialIndicator *Ref      `protobuf:"bytes,7,opt,name=social_indicator,json=socialIndicator,proto3" json:"social_indicator,omitempty"`
	Source          *Ref      `protobuf:"bytes,8,opt,name=source,proto3" json:"source,omitempty"`
}
...
func (x *SocialAspect) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
var file_olca_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x6c, 0x63, 0x61, 0x22, 0xc2, 0x03, 0x0a, 0x05, 0x41, 0x63, 0x74, 0x6f, 0x72,
	...
	0x74, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x69, 0x74, 0x79, 0x12, 0x18,
	...
	,
	...
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6c, 0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x12, 0x32,
	0x0a, 0x0a, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01,
	...
	0x70, 0x65, 0x22, 0xf9, 0x02, 0x0a, 0x08, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x12,
	0x13, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x40,
	0x74, 0x79, 0x70, 0x65, 0x12, 0x0f, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x40, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x6c, 0x61, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x29, 0x0a, 0x08, 0x63,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x10, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x18, 0x11, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x6c, 0x63,
	...
	0x5f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e,
	...
	0x67, 0x65, 0x5f, 0x64, 0x71, 0x5f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x18, 0x13, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x6c, 0x63, 0x61, 0x2e, 0x52, 0x65,
	...
	0x5f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0b,
	0x6c, 0x61, 0x73, 0x74, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x29, 0x0a,
	...
	,
	...
	0x28, 0x09, 0x52, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x29,
	...
	,
	...
	,
	...
	0x08, 0x66, 0x6c, 0x6f, 0x77, 0x54, 0x79, 0x70, 0x65, 0x12, 0x38, 0x0a, 0x0c, 0x70, 0x72, 0x6f,
	0x63, 0x65, 0x73, 0x73, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x79, 0x70, 0x65, 0x22, 0x9b, 0x01, 0x0a, 0x0c, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x52, 0x65,
	...
	,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6c, 0x61, 0x73, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_olca_proto_depIdxs = []int32{
	41,  // 0: protolca.Actor.category:type_name -> protolca.Ref
	0,   // 1: protolca.AllocationFactor.allocation_type:type_name -> protolca.AllocationType
	41,  // 2: protolca.AllocationFactor.product:type_name -> protolca.Ref
	18,  // 3: protolca.AllocationFactor.exchange:type_name -> protolca.ExchangeRef
	1,   // 4: protolca.CalculationSetup.calculation_type:type_name -> protolca.CalculationType
	41,  // 5: protolca.CalculationSetup.product_system:type_name -> protolca.Ref
	41,  // 6: protolca.CalculationSetup.impact_method:type_name -> protolca.Ref
	41,  // 7: protolca.CalculationSetup.nw_set:type_name -> protolca.Ref
	0,   // 8: protolca.CalculationSetup.allocation_method:type_name -> protolca.AllocationType
	34,  // 9: protolca.CalculationSetup.parameter_redefs:type_name -> protolca.ParameterRedef
	41,  // 10: protolca.CalculationSetup.unit:type_name -> protolca.Ref
	41,  // 11: protolca.CalculationSetup.flow_property:type_name -> protolca.Ref
	41,  // 12: protolca.Category.category:type_name -> protolca.Ref
	4,   // 13: protolca.Category.model_type:type_name -> protolca.ModelType
	41,  // 14: protolca.Currency.category:type_name -> protolca.Ref
	41,  // 15: protolca.Currency.reference_currency:type_name -> protolca.Ref
	15,  // 16: protolca.DQIndicator.scores:type_name -> protolca.DQScore
	41,  // 17: protolca.DQSystem.category:type_name -> protolca.Ref
	41,  // 18: protolca.DQSystem.source:type_name -> protolca.Ref
	14,  // 19: protolca.DQSystem.indicators:type_name -> protolca.DQIndicator
	41,  // 20: protolca.Exchange.currency:type_name -> protolca.Ref
	41,  // 21: protolca.Exchange.flow:type_name -> protolca.Ref
	41,  // 22: protolca.Exchange.flow_property:type_name -> protolca.Ref
	41,  // 23: protolca.Exchange.default_provider:type_name -> protolca.Ref
	41,  // 24: protolca.Exchange.unit:type_name -> protolca.Ref
	46,  // 25: protolca.Exchange.uncertainty:type_name -> protolca.Uncertainty
	41,  // 26: protolca.Flow.category:type_name -> protolca.Ref
	3,   // 27: protolca.Flow.flow_type:type_name -> protolca.FlowType
	24,  // 28: protolca.Flow.flow_properties:type_name -> protolca.FlowPropertyFactor
	41,  // 29: protolca.Flow.location:type_name -> protolca.Ref
	41,  // 30: protolca.FlowMap.source:type_name -> protolca.Ref
	41,  // 31: protolca.FlowMap.target:type_name -> protolca.Ref
	21,  // 32: protolca.FlowMap.mappings:type_name -> protolca.FlowMapEntry
	22,  // 33: protolca.FlowMapEntry.from:type_name -> protolca.FlowMapRef
	22,  // 34: protolca.FlowMapEntry.to:type_name -> protolca.FlowMapRef
	41,  // 35: protolca.FlowMapRef.flow:type_name -> protolca.Ref
	41,  // 36: protolca.FlowMapRef.flow_property:type_name -> protolca.Ref
	41,  // 37: protolca.FlowMapRef.unit:type_name -> protolca.Ref
	41,  // 38: protolca.FlowMapRef.provider:type_name -> protolca.Ref
	41,  // 39: protolca.FlowProperty.category:type_name -> protolca.Ref
	2,   // 40: protolca.FlowProperty.flow_property_type:type_name -> protolca.FlowPropertyType
	41,  // 41: protolca.FlowProperty.unit_group:type_name -> protolca.Ref
	41,  // 42: protolca.FlowPropertyFactor.flow_property:type_name -> protolca.Ref
	41,  // 43: protolca.FlowResult.flow:type_name -> protolca.Ref
	41,  // 44: protolca.FlowResult.location:type_name -> protolca.Ref
	41,  // 45: protolca.ImpactCategory.category:type_name -> protolca.Ref
	33,  // 46: protolca.ImpactCategory.parameters:type_name -> protolca.Parameter
	27,  // 47: protolca.ImpactCategory.impact_factors:type_name -> protolca.ImpactFactor
	41,  // 48: protolca.ImpactFactor.flow:type_name -> protolca.Ref
	41,  // 49: protolca.ImpactFactor.location:type_name -> protolca.Ref
	41,  // 50: protolca.ImpactFactor.flow_property:type_name -> protolca.Ref
	41,  // 51: protolca.ImpactFactor.unit:type_name -> protolca.Ref
	46,  // 52: protolca.ImpactFactor.uncertainty:type_name -> protolca.Uncertainty
	41,  // 53: protolca.ImpactMethod.category:type_name -> protolca.Ref
	41,  // 54: protolca.ImpactMethod.impact_categories:type_name -> protolca.Ref
	32,  // 55: protolca.ImpactMethod.nw_sets:type_name -> protolca.NwSet
	41,  // 56: protolca.ImpactResult.impact_category:type_name -> protolca.Ref
	41,  // 57: protolca.Location.category:type_name -> protolca.Ref
	41,  // 58: protolca.NwFactor.impact_category:type_name -> protolca.Ref
	31,  // 59: protolca.NwSet.factors:type_name -> protolca.NwFactor
	41,  // 60: protolca.Parameter.category:type_name -> protolca.Ref
	5,   // 61: protolca.Parameter.parameter_scope:type_name -> protolca.ParameterScope
	46,  // 62: protolca.Parameter.uncertainty:type_name -> protolca.Uncertainty
	41,  // 63: protolca.ParameterRedef.context:type_name -> protolca.Ref
	46,  // 64: protolca.ParameterRedef.uncertainty:type_name -> protolca.Uncertainty
	34,  // 65: protolca.ParameterRedefSet.parameters:type_name -> protolca.ParameterRedef
	41,  // 66: protolca.Process.category:type_name -> protolca.Ref
	10,  // 67: protolca.Process.allocation_factors:type_name -> protolca.AllocationFactor
	0,   // 68: protolca.Process.default_allocation_method:type_name -> protolca.AllocationType
	17,  // 69: protolca.Process.exchanges:type_name -> protolca.Exchange
	41,  // 70: protolca.Process.location:type_name -> protolca.Ref
	33,  // 71: protolca.Process.parameters:type_name -> protolca.Parameter
	37,  // 72: protolca.Process.process_documentation:type_name -> protolca.ProcessDocumentation
	6,   // 73: protolca.Process.process_type:type_name -> protolca.ProcessType
	41,  // 74: protolca.Process.dq_system:type_name -> protolca.Ref
	41,  // 75: protolca.Process.exchange_dq_system:type_name -> protolca.Ref
	41,  // 76: protolca.Process.social_dq_system:type_name -> protolca.Ref
	43,  // 77: protolca.Process.social_aspects:type_name -> protolca.SocialAspect
	41,  // 78: protolca.ProcessDocumentation.reviewer:type_name -> protolca.Ref
	41,  // 79: protolca.ProcessDocumentation.sources:type_name -> protolca.Ref
	41,  // 80: protolca.ProcessDocumentation.data_documentor:type_name -> protolca.Ref
	41,  // 81: protolca.ProcessDocumentation.data_generator:type_name -> protolca.Ref
	41,  // 82: protolca.ProcessDocumentation.data_set_owner:type_name -> protolca.Ref
	41,  // 83: protolca.ProcessDocumentation.publication:type_name -> protolca.Ref
	41,  // 84: protolca.ProcessLink.provider:type_name -> protolca.Ref
	41,  // 85: protolca.ProcessLink.flow:type_name -> protolca.Ref
	41,  // 86: protolca.ProcessLink.process:type_name -> protolca.Ref
	18,  // 87: protolca.ProcessLink.exchange:type_name -> protolca.ExchangeRef
	41,  // 88: protolca.ProductSystem.category:type_name -> protolca.Ref
	41,  // 89: protolca.ProductSystem.processes:type_name -> protolca.Ref
	41,  // 90: protolca.ProductSystem.reference_process:type_name -> protolca.Ref
	18,  // 91: protolca.ProductSystem.reference_exchange:type_name -> protolca.ExchangeRef
	41,  // 92: protolca.ProductSystem.target_unit:type_name -> protolca.Ref
	41,  // 93: protolca.ProductSystem.target_flow_property:type_name -> protolca.Ref
	38,  // 94: protolca.ProductSystem.process_links:type_name -> protolca.ProcessLink
	35,  // 95: protolca.ProductSystem.parameter_sets:type_name -> protolca.ParameterRedefSet
	41,  // 96: protolca.Project.category:type_name -> protolca.Ref
	41,  // 97: protolca.Project.impact_method:type_name -> protolca.Ref
	32,  // 98: protolca.Project.nw_set:type_name -> protolca.NwSet
	3,   // 99: protolca.Ref.flow_type:type_name -> protolca.FlowType
	6,   // 100: protolca.Ref.process_type:type_name -> protolca.ProcessType
	25,  // 101: protolca.SimpleResult.flow_results:type_name -> protolca.FlowResult
	29,  // 102: protolca.SimpleResult.impact_results:type_name -> protolca.ImpactResult
	7,   // 103: protolca.SocialAspect.risk_level:type_name -> protolca.RiskLevel
	41,  // 104: protolca.SocialAspect.social_indicator:type_name -> protolca.Ref
	41,  // 105: protolca.SocialAspect.source:type_name -> protolca.Ref
	41,  // 106: protolca.SocialIndicator.category:type_name -> protolca.Ref
	41,  // 107: protolca.SocialIndicator.activity_quantity:type_name -> protolca.Ref
	41,  // 108: protolca.SocialIndicator.activity_unit:type_name -> protolca.Ref
	41,  // 109: protolca.Source.category:type_name -> protolca.Ref
	8,   // 110: protolca.Uncertainty.distribution_type:type_name -> protolca.UncertaintyType
	41,  // 111: protolca.UnitGroup.category:type_name -> protolca.Ref
	41,  // 112: protolca.UnitGroup.default_flow_property:type_name -> protolca.Ref
	47,  // 113: protolca.UnitGroup.units:type_name -> protolca.Unit
